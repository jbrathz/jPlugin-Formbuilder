...
final class Admin {
	...
	public function forms_page(): void {
		...
		?>
		<div class="wrap jfb-admin-wrap" data-jfb-admin data-rest-root="<?php echo esc_url( rest_url( 'jplugin-formbuilder/v1' ) ); ?>" data-rest-nonce="<?php echo esc_attr( wp_create_nonce( 'wp_rest' ) ); ?>">
	...
	private function builder_page( string $uuid ): void {
		...
		?>
		<div class="wrap jfb-admin-wrap" data-jfb-builder data-rest-root="<?php echo esc_url( rest_url( 'jplugin-formbuilder/v1' ) ); ?>" data-rest-nonce="<?php echo esc_attr( wp_create_nonce( 'wp_rest' ) ); ?>">
