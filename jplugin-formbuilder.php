...
$plugin_data = function_exists( 'get_file_data' ) ? get_file_data( __FILE__, array( 'Version' => 'Version' ), 'plugin' ) : array( 'Version' => '1.0.13' );

define( 'JFB_VERSION', (string) ( $plugin_data['Version'] ?? '1.0.13' ) );
